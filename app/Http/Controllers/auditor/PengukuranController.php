...
class PengukuranController extends Controller
{
    ...
    public function index(Request $req)
    {
      ...
      $fungsi_hutan=$req->fungsi_hutan_home;
        ...
        //-------------------------------------------
        return view('auditor.data_pengukuran',compact('provinsi','kepemilikan','jenis','pola','jenis_pengelola'),[
          'data'=>$data_klaster,
        ]);
    }
    ...
    public function home(){
      ...
      return view('auditor.data_pengukuran.data_pengukuran_plot',compact('data_klaster'));
    }
    ...
    public function lihatpengukuran(Request $req){
      ...
      return view('auditor.data_pengukuran.detail_data_pengukuran',[
