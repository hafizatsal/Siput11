...
return view('user.nilai.skoring_semua_pengukuran',[
            ...
            if($p_kerusakan!=""){
              ...
              if($p_ktjk!=""){
                ...
                if($haksenp!=""){
                  ...
                  return view('user.nilai.skoring_kesehatan_hutan',[
    ...
    public function detail(Request $req){
      ...
      return view('user.nilai.detail_skoring_kesehatan_hutan',[
        'id_plot' => $id_plot,
    ...
    $d_mg=0;
      ...
      ->get();
        ...
        return view('user.nilai.nilai_plot',[
          'pengukuran_ke' => $pengukuran_ke,
    ...
    public function home()
    {
      ...
      $id_user=Auth::User()->id;
        ...
        return view('user.penilaian.skoring_home',[
