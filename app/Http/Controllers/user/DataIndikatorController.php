...
class DataIndikatorController extends Controller
{
    ...
    public function indexDataPengukuranp()
    {
      ...
      return view('user.data_pengukuran.data_pengukuran_prod',compact('data_klaster')
      );
    }
    ...
    public function indexDataPengukuranv()
    {
      ...
      return view('user.data_pengukuran.data_pengukuran_vit',compact('data_klaster')
      );
    }
    ...
    public function indexDataPengukuranb()
    {
      ...
      return view('user.data_pengukuran.data_pengukuran_bio',compact('data_klaster')
      );
    }
    ...
    public function indexDataPengukurank()
    {
      ...
      return view('user.data_pengukuran.data_pengukuran_ktk',compact('data_klaster')
      );
    }
    ...
    public function dataIndikator($id)
    {
      ...
      return view('user.data_pengukuran.daftar_indikator',compact('id','id_plot','id_klaster_plot'));
    }
    ...
    public function paramBiodiversitas($id)
    {
      ...
      return view('user.data_pengukuran.parameter_biodiversitas',compact('id','id_plot','id_klaster_plot'));
    }
    ...
    public function paramProduktivitas($id)
    {
      ...
      return view('user.data_pengukuran.parameter_produktivitas',compact('id','id_plot','id_klaster_plot'));
    }
    ...
    public function paramVitalitas($id)
    {
      ...
      return view('user.data_pengukuran.parameter_vitalitas',compact('id','id_plot','id_klaster_plot'));
    }
    ...
    public function paramKtk($id)
    {
      ...
      return view('user.data_pengukuran.parameter_ktk',compact('id','id_plot','id_klaster_plot'));
    }
    ...
    public function biodivPohon($id)
    {
      ...
      $koor_ls_ful_p=$l_splitName_p[0].' ᴼ '.$l_splitName2_p[0].' ’ '.$l_splitName3_p[0].' ”';
        ...
        return view('user.biodiversitas.biodiv_pohon',[
          'id'=>$id,
    ...
    public function biodivFauna($id)
    {
      ...
      return view('user.biodiversitas.biodiv_fauna',[
        'id' => $id,
        'data_pengukuran'=>$data_pengukuran,
    ...
    public function lbds($id)
    {
      $id=decrypt($id);
        ...
        return view('user.produktivitas.prod_lbds',[
          'id'=>$id,
          'data_pengukuran'=>$data_pengukuran,
          'koor_bt_ful_p'=>$koor_bt_ful_p,
          'koor_ls_ful_p'=>$koor_ls_ful_p,
    ...
    public function kerusakan($id)
    {
      ...
      ->get();
        ...
        return view('user.vitalitas.kerusakan',[
          'id'=>$id,
          'data_pengukuran'=>$data_pengukuran,
          'data_pohon'=>$data_pohon,
          'data_pohon_import'=>$data_pohon_import,
    ...
    public function tajuk($id)
    {
      ...
      ->get();
        ...
        return view('user.vitalitas.kondisi_tajuk',[
          'id'=>$id,
          'data_pengukuran'=>$data_pengukuran,
          'data_pohon'=>$data_pohon,
          'data_pohon_import' => $data_pohon_import,
