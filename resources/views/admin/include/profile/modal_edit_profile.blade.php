  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="post" action="{{route('admin.profile_edit2')}}" enctype="multipart/form-data"
        ...
        document.getElementById('profile').value='Sedang memperbarui...';">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="text" required class="form-control" id="nama" name="nama" value="{{Auth::user()->nama}}">
            </div>
