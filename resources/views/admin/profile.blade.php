     ...
     <div class="box box-primary">
       <div class="box-header with-border">
        ...
        <div class="box-footer pull-right">
          ...
          <a name="ubah_password" id="ubah_password" class="btn btn-warning" href="{{route('admin.ubah_password_admin')}}">Ubah Password</a>
        </div>
        </div>
      </div>
    </div>
...
@include('admin.include.profile.modal_edit_profile')
@endsection
