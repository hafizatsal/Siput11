        ...
        <div class="box-body">
          ...
          <table id="data_klaster" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>Produktivitas</td>
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.pengukuran_produktivitas', encrypt($id))}}"></a>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>Vitalitas</td>
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.pengukuran_vitalitas', encrypt($id))}}"></a>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>Biodiversitas</td>
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.pengukuran_biodiversitas', encrypt($id))}}"></a>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.pengukuran_ktk', encrypt($id))}}"></a>
              </td>
            </tr>
