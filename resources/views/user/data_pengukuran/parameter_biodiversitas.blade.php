        ...
        <div class="box-body">
          <table id="data_klaster" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.bio_pohon',encrypt($id))}}"></a>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.bio_fauna',encrypt($id))}}"></a>
              </td>
            </tr>
