...
<li><a href="#">Paramater Kualitas Tapak</a></li>
@endsection
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Data Parameter Kualitas Tapak</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="data_klaster" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>Sifat Kimia</td>
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.kimia',encrypt($id))}}"></a>
              </td>
            </tr>
