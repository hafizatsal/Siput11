...
<li><a href="#">Paramater Vitalitas</a></li>
@endsection
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Data Parameter Vitalitas</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <table id="data_klaster" class="table table-bordered table-striped">
            ...
            <tr>
              <td>1</td>
              <td>Kerusakan Pohon</td>
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.kerusakan',encrypt($id))}}"></a>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>Kondisi Tajuk</td>
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('user.tajuk',encrypt($id))}}"></a>
              </td>
            </tr>
