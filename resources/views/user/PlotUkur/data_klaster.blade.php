...
<div class="box animated fadeIn slower" style="margin:20px auto 0 auto; width:50%">
  <div class="box-header">
      ...
      <form class="form-horizontal form-label-left" action="{{route('user.data_klaster.lihat')}}" method="GET">
          {{ csrf_field() }}
          <div class="form-group">
              ...
              <div class="form-group">
                ...
                <button style="margin-top:10px; width:170px;" type="button" name="tambah_data" id="tambah_data" class="btn btn-success center-block"><i class="fa fa-plus"></i> Tambah Data Klaster</button>
        </form>
