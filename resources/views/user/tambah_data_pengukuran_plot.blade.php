...
<li><a href="{{route('user.lihat_plot', encrypt($id_plot))}}">Detail Data Plot</a></li>
  ...
  <div class="col-xs-12 table">
    <div class="box">
        <div class="box-header">
          ...
          <h4>
            <a class="btn btn-success btn-xs" href="{{route('user.pertumbuhan', encrypt($data_pengukuran->id_pengukuran))}}">Pertumbuhan</a>
