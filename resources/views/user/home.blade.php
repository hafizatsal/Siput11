     ...
     <div class="box box-primary animated fadeIn">
       <div class="box-header with-border">
        ...
        <!-- </marquee> -->
          ...
          <p><span class="fa fa-fw fa-book"></span> Panduan penggunaan SIPUT dapat di unduh <a href="{{route('user.download_panduan_siput')}}">disini</a>.</p>
          <p><span class="fa fa-fw fa-file-pdf-o"></span> Panduan <i>import</i> data pengukuran kesehatan hutan dapat di unduh <a href="{{route('user.download_panduan_import')}}">disini</a>.</p>
