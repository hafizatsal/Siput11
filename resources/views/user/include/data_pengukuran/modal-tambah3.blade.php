    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="formPengukuran" method="POST" action="{{ url('user/data_pengukuran/insert') }}">
                    @csrf
...
<script>
    ...
    $('#jenis').on('change', function() {
        var id = $(this).val();
        $.get("{{ url('user/json-fungsi2') }}?id_jenis=" + id, function(data){
    ...
    $('#provinsi').on('change', function(){
        var id = $(this).val();
        $.get("{{ url('user/json-kabupaten2') }}?id_provinsi=" + id, function(data){
    ...
    $('#kabupaten').on('change', function(){
        var id = $(this).val();
        $.get("{{ url('user/json-kecamatan2') }}?id=" + id, function(data){
            $('#kecamatan').empty().append('<option value="">=== Pilih ===</option>');
            $('#desa').empty().append('<option value="">=== Pilih ===</option>');
            $.each(data, function(i, v){
    ...
    $('#kecamatan').on('change', function(){
        var id = $(this).val();
        $.get("{{ url('user/json-desa2') }}?id=" + id, function(data){
            $('#desa').empty().append('<option value="">=== Pilih ===</option>');
            $.each(data, function(i, v){
