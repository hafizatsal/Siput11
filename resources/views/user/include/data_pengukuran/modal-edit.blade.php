...
<script>
    ...
    $('#edit_jenis').on('change', function(){
        $.get("{{ url('user/json-fungsi2') }}?id_jenis=" + this.value, function(data){
            $('#edit_fungsi').empty();
    ...
    $('#edit_provinsi').on('change', function(){
        $.get("{{ url('user/json-kabupaten2') }}?id_provinsi=" + this.value, function(data){
    ...
    $('#edit_kabupaten').on('change', function(){
        $.get("{{ url('user/json-kecamatan2') }}?id=" + this.value, function(data){
    ...
    $('#edit_kecamatan').on('change', function(){
        $.get("{{ url('user/json-desa2') }}?id=" + this.value, function(data){
