        ...
        <div class="box-body">
          ...
          <table id="data_klaster_plot" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <a style="margin-top:10px" class="btn btn-success btn-xs" data-info="" href="{{route('auditor.klaster.data_klaster.detail', encrypt($d->id_klaster_plot))}}"> <i class="fa fa-search"></i> </a>
