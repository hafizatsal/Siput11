...
@endsection
@section('breadcrumb')
<li><a href="{{route('auditor.data_klaster')}}">Data Klaster Plot</a></li>
@endsection
        ...
        <div class="box-body">
          ...
          <table id="data_kategori_klaster" class="table table-bordered table-hover">
            ...
            <tr>
              ...
              <a style="width:50px; margin-top:10px" class="btn btn-success btn-xs" data-info="" href="{{route('auditor.klaster_plot', encrypt($d->id_data_klaster))}}"> <i class="fa fa-search"></i> </a>
                @else
              <a style="width:50px; margin-top:10px" class="btn btn-success btn-xs" data-info="" href="{{route('auditor.klaster_plot', encrypt($d->id_data_klaster2))}}"> <i class="fa fa-search"></i> </a>
                @endif
              ...
              <a style="width:50px; margin-top:10px" class="btn btn-info btn-xs" href="{{route('auditor.isi_nilai_tertimbang', encrypt($d->id_data_klaster))}}"><i class="fa fa-balance-scale"></i></a>
