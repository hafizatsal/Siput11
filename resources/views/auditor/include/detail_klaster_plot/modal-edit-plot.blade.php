  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" method="get" action="{{route('auditor.klaster.data_klaster.editPlot')}}"
    ...
    <div class="col-xs-6">
      <div class="form-group">
        ...
        <div class="input-group">
            <input type="text" class="form-control" placeholder="00 &deg; 00 ' 00.00 &quot;" id="lintang" name="lintang">
            <!-- insert this line -->
  ...
  <div class="col-xs-6">
    <div class="form-group">
      ...
      <div id="koordinat_bujur" class="form-group">
        <div class="input-group">
            <input type="text" class="form-control" placeholder="000 &deg; 00 ' 00.00 &quot;" id="koordinat" name="koordinat">
            <!-- insert this line -->
            <span class="input-group-addon" style="width:0px; padding-left:0px; padding-right:0px; border:none;"></span>
