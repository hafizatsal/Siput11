  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form role="form" method="post" action="{{route('auditor.tambah_foto_ktk')}}" enctype="multipart/form-data"
        ...
        document.getElementById('submit_foto').value='Sedang menyimpan...';">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="hidden" id="kode_plot" name="kode_plot" value="{{$id_plot}}">
