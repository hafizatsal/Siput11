  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form role="form" method="post" action="{{route('auditor.edit_foto_kerusakan')}}" enctype="multipart/form-data"
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="edit_file_foto">Foto *</label>
                  <input type="file" name="edit_file_foto">
              </div>
...
$('#modal_edit_foto').on('show.bs.modal', function(event){
  ...
  $.ajax({
      type: 'post',
      url: '{{route("auditor.json_foto_kerusakan")}}',
      data: {
