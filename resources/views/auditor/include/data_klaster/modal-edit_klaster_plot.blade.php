					...
					<div class="col-md-12">
						<div class="nav-tabs-custom" id="tabedit">
							<ul class="nav nav-tabs">
								<li id="tab3" class="active"><a id="tabs3" href="#tab_3">Identitas Klaster Plot Ukur</a>
								</li>
								<li id="tab4" class="disabled"><a id=tabs4>Titik Ikat Klaster Plot Ukur</a>
								</li>
							</ul>
							<div class="tab-content">
								<!-- tab 3 -->
								<div class="tab-pane active" id="tab_3">
									<form id="formedit" class="" action="{{route('auditor.klaster.data_klaster.edit')}}" method="get" onsubmit="document.getElementById('submit2').disabled=true;
                          document.getElementById('submit2').value='Sedang memperbarui...';">{{csrf_field()}}
											...
											<div class="col-md-6">
												<div id="input-pemilik2" class="form-group">
													...
													<select class="form-control" name="kepemilikan2" id="kepemilikan2">
														<option value="" disable="true" selected="true">=== Pilih Status Hukum ===</option>@foreach ($kepemilikan as $key => $value)
														<option value="{{$value->id_hak_milik}}">{{$value->hak_milik}}</option>@endforeach</select>
													<label hidden id="id_pemilik2" class="control-label"><i>Kepemilikan harus diisi!</i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div id="input-jenis-hutan2" class="form-group">
													...
													<label hidden id="id_jenis2" class="control-label"><i>Tipe hutan salah! (2-50 huruf).</i>
													</label>
												</div>
											</div>
											<div class="col-md-6">
												<div id="input-fungsi-hutan2" class="form-group">
													...
													<label hidden id="id_fungsi2" class="control-label"><i>Fungsi hutan harus diisi!</i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div id="input-provinsi2" class="form-group">
													...
													<label hidden id="id_provinsi2" class="control-label"><i>Provinsi harus diisi!</i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div id="input-kabupaten2" class="form-group">
													...
													<label hidden id="id_kabupaten2" class="control-label"><i>Kabupaten harus diisi!</i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div id="input-kecamatan2" class="form-group">
													...
													<label hidden id="id_kecamatan2" class="control-label"><i>Kecamatan harus diisi!</i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div id="input-desa2" class="form-group">
													...
													<label hidden id="id_desa2" class="control-label"><i>Desa harus diisi!</i>
													</label>
												</div>
											</div>
										</div>
											...
											<div class="col-xs-6">
												<div class="form-group">
													...
													<div id="lintang_klaster2" class="form-group">
														...
														<label hidden id="id_lintang_klaster2" class="control-label"><i>Lintang harus sesuai dengan format!</i>
														</label>
													</div>
												</div>
											</div>
											<div class="col-xs-6">
												<div class="form-group">
													...
													<div id="bujur_klaster2" class="form-group">
														...
														<label hidden id="id_bujur_klaster2" class="control-label"><i>Bujur harus sesuai dengan format!</i>
														</label>
													</div>
												</div>
											</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div id="input-altitude2" class="form-group">
													...
													<label hidden id="id_altitude2" class="control-label"><i>Altitude harus berupa angka!</i>
													</label>
												</div>
											</div>
											<div class="col-md-6">
												<div id="input-luas-hutan2" class="form-group">
													...
													<label hidden id="id_luas_hutan2" class="control-label"><i>Luas hutan harus berupa angka!</i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div id="input-tahun-tanam2" class="form-group">
													...
													<label hidden id="id_tahun_tanam2" class="control-label"><i>Tahun tanam salah! (Format: 2007,2008,2009).</i>
													</label>
												</div>
											</div>
											<div class="col-md-6">
										...
										<div class="row">
											<div class="col-md-6">
												<div id="input-panjang2" class="form-group">
													...
													<label hidden id="id_panjang2" class="control-label"><i>Panjang harus diisi!</i>
													</label>
												</div>
											</div>
											<div class="col-md-6">
												<div id="input-lebar2" class="form-group">
													...
													<label hidden id="id_lebar2" class="control-label"><i>Lebar harus diisi!</i>
													</label>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div id="input-jenis-tanaman2" class="form-group">
													<label>Jenis Tanaman</label>
													<input type="text" name="jenis_tanaman2" id="jenis_tanaman2" class="form-control" placeholder="Contoh: sengon, jagung, singkong, pisang" value="">
												</div>
											</div>
										</div>
										<!-- label error -->
									...
									<div class="row">
										<div class="col-md-12">
											<div id="input-titik-ikat2" class="form-group">
												...
												<label hidden id="id_titik_ikat2" class="control-label"><i>Titik ikat salah! (2-50 huruf).</i>
												</label>
											</div>
										</div>
									</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<div id="lintang_ikat2" class="form-group">
													...
													<label hidden id="id_lintang_ikat2" class="control-label"><i>Lintang harus sesuai dengan format!</i>
													</label>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div id="bujur_ikat2" class="form-group">
													...
													<label hidden id="id_bujur_ikat2" class="control-label"><i>Bujur harus sesuai dengan format!</i>
													</label>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div id="input-azimuth2" class="form-group">
												...
												<label hidden id="id_azimuth2" class="control-label"><i>Azimuth harus diisi!</i>
												</label>
											</div>
										</div>
										<div class="col-md-6">
											<div id="input-jarak-titik-ikat2" class="form-group">
												...
												<label hidden id="id_jarak_titik_ikat2" class="control-label"><i>Jarak titik ikat harus diisi!</i>
												</label>
											</div>
										</div>
									</div>
...
<script>
  ...
  $(document).ready(function () {
  	var validate = 0;
  	// validate untuk memvalidasi inputan, jika memenuhi dapat lanjut ke tab berikutnya
    ...
    // untuk validasi jenis hutan
  	...
  	$('#input-jenis-hutan2').on('input', function () {
  		jenis2 = $('#jenis2').val();
  		var valid_jenis = /^[a-zA-Z ]{2,50}$/; //untuk validasi kategori
    ...
    // untuk validasi nama provinsi
  	...
  	$('#lintang_klaster2').on('input', function () {
  	...
  	$('#bujur_klaster2').on('input', function () {
  	...
  	// validasi altitude2
  	var v_altitude2 = 1;
  	var valid_altitude2 = /^([0-9]{0,}(\.[0-9]{1,}){0,1})$/; //untuk validasi integer
  	...
  	var v_luas_hutan2 = 1;
  	var valid_luas_hutan2 = /^([0-9]{0,}(\.[0-9]{1,}){0,1})$/; //untuk validasi integer
  	...
  	$('#input-tahun-tanam2').on('input', function () {
  		...
  		if (tahun_tanam2.match(valid_tahun_tanam)  || tahun_tanam2=="") {
  	...
  	var v_panjang2 = 1;
  	var valid_panjang2 = /^([0-9]{0,}(\.[0-9]{1,}){0,1})$/; //untuk validasi integer
  	...
  	var v_lebar2 = 1;
  	var valid_lebar2 = /^([0-9]{0,}(\.[0-9]{1,}){0,1})$/; //untuk validasi integer
  	...
  	var v_jenis_tanaman2 = 1;
  	var valid_jenis_tanaman2 = /^[a-zA-Z ]{0,50}$/; //untuk validasi jenis tanaman
  	$('#input-jenis-tanaman2').on('input', function () {
  		jenis_tanaman2 = $('#jenis_tanaman2').val();
  		if (jenis_tanaman2.match(valid_jenis_tanaman2)) {
  			$('#input-jenis-tanaman2').attr("class", "form-group has-success");
  			v_jenis_tanaman2 = 1;
  		} else {
  			v_jenis_tanaman2 = 1;
  			$('#input-jenis-tanaman2').attr("class", "form-group has-success");
  	...
  	var v_titik_ikat2 = 1;
  	var valid_titik_ikat = /^[a-zA-Z ]{2,50}$/; //untuk validasi titik ikat
      ...
      if(v_titik_ikat2 + v_azimuth2 + v_jarak_titik_ikat2 + v_lintang_ikat2 + v_bujur_ikat2 == 5){
  	...
  	var v_azimuth2 = 1;
  	var valid_azimuth2 = /^([0-9]{0,}(\.[0-9]{1,}){0,1})$/; //untuk validasi integer
  	...
  	// untuk validasi jarak
  	var v_jarak_titik_ikat2 = 1;
  	var valid_jarak_titik_ikat2 = /^([0-9]{0,}(\.[0-9]{1,}){0,1})$/; //untuk validasi integer
  	...
  	$('#lintang_ikat2').on('input', function () {
  	...
  	// untuk pengambilan data dari database
  			...
  			success: function (data) {
  				$.each(data, function (key, value) {
  					...
  					$('#usia2').val(value['usia']);
						$('#jenis_tanaman2').val(value['jenis_tanaman']);
    ...
    // button
  	$('#btnljt2').click(function (e) {
  		validate2 = v_kode_klaster_plot2 + v_pemilik2 + v_jenis2 + v_fungsi2 + v_provinsi2 + v_kabupaten2 + v_kecamatan2 + v_desa2 + v_lintang_klaster2 + v_bujur_klaster2 + v_altitude2 + v_luas_hutan2 + v_tahun_tanam2 + v_usia2 + v_pengelola2 + v_keterangan_pengelola2 + v_panjang2 + v_lebar2 + v_pola_tanam2 + v_jenis_tanaman2;
  		// validate2=20;
  		if (validate2 == 20) {
  			$('#id_lanjut2').hide();
  			e.preventDefault();
