    ...
    <table id="nilai_kesehatan" class="table table-bordered table-striped">
      ...
      <tr>
        ...
        <td style="text-align: center; vertical-align: middle">
          ...
          <form id="pengukuran_pertama" method="post" class="" action="{{route('/penilaian/kesehatan_auditor')}}">
          {{csrf_field()}}
      ...
      <tr>
        ...
        <td style="text-align: center; vertical-align: middle">
          ...
          <form id="pengukuran_kedua" method="post" class="" action="{{route('/penilaian/kesehatan_auditor')}}">
          {{csrf_field()}}
      ...
      <tr>
        <td>3</td>
        <td>{{$id_klaster3[0]->nama_pengukur}}</td>
        @if($p_lbds!="")
        <td>
          {{$na_total_lbds3[0]}}
        </td>
        ...
        @if($p_kerusakan!="")
        <td>
          {{$na_total_kerusakan3[0]}}
        </td>
        @endif
        @if($haksenp!="")
        <td>
          {{$na_total_biodiv_pohon3[0]}}
        </td>
        @endif
        @if($p_jpliu!="")
        <td>
          {{$na_total_biodiv_pohon_jpliu3[0]}}
        </td>
        @endif
        @if($p_dmg!="")
        <td>
          {{$na_total_biodiv_pohon_dmg3[0]}}
        </td>
        @endif
        @if($haksenf!="")
        <td>
          {{$na_total_biodiv_fauna3[0]}}
        </td>
        @endif
        @if($p_jpliuf!="")
        <td>
          {{$na_total_biodiv_fauna_jpliuf3[0]}}
        </td>
        @endif
        @if($p_dmgf!="")
        <td>
          {{$na_total_biodiv_fauna_dmgf3[0]}}
        </td>
        @endif
        @if($p_kimia!="")
        <td>
        ...
        <td style="text-align: center; vertical-align: middle">
          ...
          <form id="pengukuran_ketiga" method="post" class="" action="{{route('/penilaian/kesehatan_auditor')}}">
          {{csrf_field()}}
          ...
          <a class="fa fa-search btn btn-success btn-xs" onclick="document.getElementById('pengukuran_ketiga').submit()"></a>
...
// LINE CHART
   var line = new Morris.Line({
     ...
     data: [
       ...
       {y: '{{$id_klaster3[0]->tahun_pengukuran}}', lbds: {{$na_total_lbds3[0]}}, tajuk: {{$na_total_tajuk3[0]}}, kerusakan: {{$na_total_kerusakan3[0]}}, Biodiversitas: {{$na_total_biodiv_pohon3[0]}}, Tapak: {{$na_total_cec3[0]}} },
     ],
     xkey: 'y',
