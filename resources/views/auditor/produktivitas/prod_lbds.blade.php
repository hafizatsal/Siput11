         ...
         <tbody>
           ...
           <select id="pilihplot" name="pilihplot" onchange="location = this.value;">
            ...
            @php($no=0) @foreach($id_pengukuran as $id_pengukuran)
             <option value="{{route('auditor.lbds', encrypt($id_pengukuran))}}">{{$nama_plots[$no]}}</option>
             @php($no++)
             @endforeach
           </select>
           </td>
...
@include('auditor.include.isi_pengukuran.modal_tambah_foto_pengukuran')
@include('auditor.include.isi_pengukuran.modal_edit_foto_pengukuran')
@include('auditor.include.isi_pengukuran.modal_delete_foto')
@include('auditor.include.data_pengukuran_plot.pertumbuhan.pertumbuhan')
@include('auditor.include.data_pengukuran_plot.pertumbuhan.modal_delete_pertumbuhan')
@include('auditor.include.data_pengukuran_plot.pertumbuhan.delete_all_pertumbuhan')
@include('auditor.include.import.import_lbds')
