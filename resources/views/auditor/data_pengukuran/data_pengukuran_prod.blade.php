...
@section('breadcrumb')
<li><a href="#">Data Pengukuran Produktivitas</a></li>
@endsection
...
<div class="box animated fadeIn slower" style="margin:20px auto 0 auto; width:50%">
  <div class="box-header">
      ...
      <form class="form-horizontal form-label-left" action="{{route('auditor.plbds')}}" method="GET">
          {{ csrf_field() }}
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <select required class="form-control" name="nama_parameter" id="nama_parameter">
                          ...
                          <option value="1">Pertumbuhan</option>
                        </select>
                      </div>
                    </div>

                <button style="margin-top:10px; width:170px;" type="submit" name="lihat" id="lihat" value="lihat" class="btn btn-primary center-block"><i class="fa fa-search"></i> Lihat Produktivitas</button>
        </form>
