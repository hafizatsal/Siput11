...
@section('breadcrumb')
<li><a href="#">Data Pengukuran Vitalitas</a></li>
@endsection
...
<div class="box animated fadeIn slower" style="margin:20px auto 0 auto; width:50%">
  <div class="box-header">
      ...
      <form class="form-horizontal form-label-left" action="{{route('auditor.pvit')}}" method="GET">
          {{ csrf_field() }}
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <select required class="form-control" name="nama_parameter" id="nama_parameter">
                          ...
                          <option value="1">Kerusakan Pohon</option>
                          <option value="2">Kondisi Tajuk</option>
                        </select>
                      </div>
                    </div>

                <button style="margin-top:10px; width:170px;" type="submit" name="lihat" id="lihat" value="lihat" class="btn btn-primary center-block"><i class="fa fa-search"></i> Lihat Vitalitas</button>
        </form>
