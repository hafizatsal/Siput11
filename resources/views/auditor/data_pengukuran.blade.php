...
@section('main_section')
        ...
        <div class="box-body">
          <table id="data_pengukuran" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>{{$d->luas}} ha</td>
              <td>
              <a class="fa fa-search btn btn-success btn-xs" data-info="" href="{{route('auditor.klaster.data_klaster.detail', encrypt($d->id_klaster_plot))}}"></a>
              ...
              <a class="fa fa-fire btn btn-info btn-xs" data-info="" href="{{route('auditor.isi_nilai_tertimbang', encrypt($d->id_klaster_plot))}}"></a>
  ...
  <!-- /.row -->
   ...
   {{-- include modal --}}
   @include('auditor.include.data_pengukuran.modal-delete')
   @include('auditor.include.data_pengukuran.modal-edit')
   @include('auditor.include.data_pengukuran.modal-tambah3')
