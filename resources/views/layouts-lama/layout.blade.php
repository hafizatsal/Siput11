      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview @yield('active_plot_ukur')">
          ...
          <ul class="treeview-menu">
            <li class="@yield('active_data_klaster')"><a href="{{route('data_klaster')}}"><i class="fa fa-circle-o"></i> Data Kategori Klaster</a></li>
            <li class="@yield('active_klaster')"><a href="{{route('data_klaster_plot')}}"><i class="fa fa-circle-o"></i> Data Klaster Plot</a></li>
            <li class="@yield('active_plot')"><a href="{{route('data_plot')}}"><i class="fa fa-circle-o"></i> Data Plot</a></li>
        ...
        <li class="treeview @yield('active_data_pengukuran')">
          <a href="#">
            <i class="fa fa-fw fa-table"></i> <span>Data Pengukuran</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="@yield('active_produktivitas')"><a href="{{route('data_pengukuranp')}}"><i class="fa fa-circle-o"></i> Produktivitas</a></li>
            <li class="@yield('active_vitalitas')"><a href="{{route('data_pengukuranv')}}"><i class="fa fa-circle-o"></i> Vitalitas</a></li>
            <li class="@yield('active_biodiversitas')"><a href="{{route('data_pengukuranb')}}"><i class="fa fa-circle-o"></i> Biodiversitas</a></li>
            <li class="@yield('active_kualitas_tapak')"><a href="{{route('data_pengukurank')}}"><i class="fa fa-circle-o"></i> Kualitas Tapak</a></li>
          </ul>
        </li>
        <li class="treeview @yield('active_penilaian')">
          ...
          <ul class="treeview-menu">
            <li class="@yield('active_nilai_akhir')"><a href="{{route('/penilaian/klaster')}}"><i class="fa fa-circle-o"></i> Nilai Akhir KesHut</a></li>
          </ul>
        </li>
      </ul>
